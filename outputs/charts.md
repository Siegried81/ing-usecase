...
The dictionary defines 104 features. The comparisons here use **38**. Nothing is thrown away quietly — this is the whole reduction:
...
104 features in the dictionary
  ...
  = 38  features used in this comparison
```
...
**What this run shows.** ING scores **0.24** — clearly with the traditional banks. Computed over 38 features.

The two groups do not overlap: the most challenger-like incumbent sits at 0.28 and the most traditional challenger at 0.56, a gap of 0.28. That separation is what makes the axis meaningful — if the groups interleaved, the projection would be measuring noise.

| Bank | Category | Position |
| --- | --- | --- |
| argenta | traditional | -0.28 |
| cbc | traditional | -0.19 |
| beobank | traditional | -0.15 |
| bnp_paribas_fortis | traditional | -0.08 |
| crelan | traditional | -0.04 |
| kbc | traditional | 0.01 |
| vdk | traditional | 0.01 |
| hellobank | traditional | 0.21 |
| ing **(focus)** | traditional | 0.24 |
| belfius | traditional | 0.28 |
| keytrade | challenger | 0.56 |
| n26 | challenger | 0.87 |
| bunq | challenger | 1.20 |
| revolut | challenger | 1.37 |
...
**What this run shows.** The largest gap is **persuasion lever count** at +2.5 SD (ing 3.67 against a peer mean of 1.74).
...
**What this run shows.** The banks closest to ING are **belfius** (4.9), **argenta** (6.5), **keytrade** (6.6).
